...
class Userfunctions(MainWindow):
    ...
    def Geometry_display(self):
        try:
            ...
            self.ui.the1_current.setText(str(Userfunctions.convert_to_Deg(self,self.the[0])))
            self.ui.the2_current.setText(str(Userfunctions.convert_to_Deg(self,self.the[1])))
            self.ui.the3_current.setText(str(Userfunctions.convert_to_Deg(self,self.the[2])))
