...
class Userfunctions(MainWindow):
    ...
    def Geometry_display(self):
        try:
            ...
            self.ui.the1_current.setText(str(self.the[0]))
            self.ui.the2_current.setText(str(self.the[1]))
            self.ui.the3_current.setText(str(self.the[2]))
            ...
            self.ui.current_x.setText(str(x[3]))
            self.ui.current_y.setText(str(y[3]))
            self.ui.current_z.setText(str(z[3]))
            self.screen.draw()
