...
class MainWindow(QMainWindow):
    ...
    def eventFilter(self, watched, event):
        if watched == self.ui.adjust_thelta and event.type() == QtCore.QEvent.MouseButton :
            UIFunctions.reset(self)

    def mousePressEvent(self,watched, event):
        self.dragPos = event.ui.adjust_thelta()
        if event.buttons() == Qt.LeftButton and watched == self.ui.adjust_thelta:
